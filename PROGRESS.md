...
- `src/store/difficulties.ts`: Normal(x1) / Beat Master(x1.25) / DJ Legend(x1.5), 색상 3/4/5개
...
## 다음 작업 (우선순위 순)
1. **좌우 버튼 레인 + DJMong** — `PlayScreen.tsx`의 GameCanvas 자리(또는 별도 컴포넌트)에 구현
